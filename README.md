...
## Javascript
It starts with RequireJS, and main.js holds 
### app.js
App.js is the beginning of all Frontend interaction. It bootstraps the frontend application, initializes analytics, Facebook and other third party SDKs.
